    ...
    public void draw(Graphics g){ // method untuk gambar background, player, pipe, game over
        ...
        if(pipes != null){
            ...
            if (logic.isGameOver()) {
                ...
                g.drawString("GAME OVER", 70, 230);

                g.setFont(new Font("Arial", Font.BOLD, 22));
                g.drawString("Score: " + logic.score, 120, 270);

                g.setFont(new Font("Arial", Font.PLAIN, 18));
                g.drawString("Press R to Restart", 95, 310);
                g.drawString("Press ESC to back to Menu", 60, 340);
            }
        }
    }
